...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ProductsReducer = __webpack_require__(258);
	...
	var store = createStoreWithMiddleware(_ProductsReducer2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MainApp = __webpack_require__(233);

	var _MainApp2 = _interopRequireDefault(_MainApp);

	var _ProductSelectionPage = __webpack_require__(242);

	var _ProductSelectionPage2 = _interopRequireDefault(_ProductSelectionPage);

	var _ConfirmationPage = __webpack_require__(256);

	var _ConfirmationPage2 = _interopRequireDefault(_ConfirmationPage);

	var _ErrorPage = __webpack_require__(257);
	...
	exports.default = _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	        ...
	        _react2.default.createElement(_reactRouter.IndexRoute, { component: _ProductSelectionPage2.default }),
	        _react2.default.createElement(_reactRouter.Route, { path: 'confirmed', component: _ConfirmationPage2.default }),
	        _react2.default.createElement(_reactRouter.Route, { path: 'error-page', component: _ErrorPage2.default })
	    )
	);
	    ...
	    _createClass(MainApp, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { style: { 'width': 100 + '%', 'height': 400 + 'px', 'position': 'relative' } },
	    ...
	    _createClass(Footer, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'footer' },
	                'Exercise done by Sathish Kumar Govindaraju'
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Products = __webpack_require__(243);

	var _Products2 = _interopRequireDefault(_Products);

	var _Basket = __webpack_require__(252);
	...
	var _CookieHelper = __webpack_require__(255);

	var cookieHelper = _interopRequireWildcard(_CookieHelper);
	...
	var ProductSelectionPage = function (_React$Component) {
	    _inherits(ProductSelectionPage, _React$Component);

	    function ProductSelectionPage() {
	        _classCallCheck(this, ProductSelectionPage);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ProductSelectionPage).apply(this, arguments));
	    }

	    _createClass(ProductSelectionPage, [{
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	            var store = this.context.store;

	            var customerId = cookieHelper.getCookieValue("customerId");
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { style: { 'marginLeft': 3 + '%' } },
	                _react2.default.createElement(_Products2.default, { className: 'products-holder', products: this.props.productsList.NEWS, categoryName: "News" }),
	                _react2.default.createElement(_Products2.default, { className: 'products-holder', products: this.props.productsList.SPORTS, categoryName: "Sports" }),
	                _react2.default.createElement(_Basket2.default, { className: 'basket' })
	            );
	        }
	    }]);
	...
	ProductSelectionPage.defaultProps = {
	    productsList: {
	        "NEWS": [],
	        "SPORTS": []
	    }
	...
	ProductSelectionPage.propTypes = {
	    productsList: _react.PropTypes.object,
	    selectedProducts: _react.PropTypes.array
	};
	...
	exports.default = (0, _reactRedux.connect)(select)(ProductSelectionPage);
	        ...
	        value: function render() {
	            ...
	            if (this.props.products) {
	                products = this.props.products.map(function (data, i) {
	                    return _react2.default.createElement(_Checkbox2.default, { name: data, key: i });
	                });
	            } else {
	                products = "";
	            }
	    ...
	    function Checkbox(props) {
	        ...
	        _this.onChange = function () {
	            ...
	            if (_this.state.isChecked) {
	                ...
	                store.dispatch(actions.deselectProduct(_this.props.name));
	            } else {
	                _this.setState({ isChecked: true });
	                store.dispatch(actions.selectProduct(_this.props.name));
	            }
	        };
	    ...
	    _createClass(Checkbox, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement('input', { type: 'checkbox', checked: this.state.isChecked, onChange: this.onChange }),
	                _react2.default.createElement(
	                    'label',
	                    null,
	                    ' ',
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.showProducts = undefined;
	...
	var showProducts = exports.showProducts = function showProducts(data) {
	    return {
	...
	function getProducts(customerId) {
	    return function (dispatch) {
	        (0, _isomorphicFetch2.default)('http://localhost:8080/api/get-products?customerId=' + customerId).then(function (result) {
	            if (result.status === 200) {
	                return result.json();
	            } else {
	                _History2.default.push('/error-page');
	            }
...
/***/ function(module, exports) {
	...
	var SHOW_PRODUCTS = exports.SHOW_PRODUCTS = 'SHOW_PRODUCTS';
	var PRODUCT_SELECTED = exports.PRODUCT_SELECTED = 'PRODUCT_SELECTED';
	var PRODUCT_DESELECTED = exports.PRODUCT_DESELECTED = 'PRODUCT_DESELECTED';
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = new _createBrowserHistory2.default();
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".products-holder{\n    width:30%;\n    height: 250px;\n    float: left;\n    background-color: #dddddd;\n    margin:1%;\n}\n\n.category-name{\n    color: black;\n    font-size: 20px;\n    font-weight: bold;\n    margin : 10px 0 10px 10px;\n}\n\n.products{\n    color: black;\n    font-size: 16px;\n}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _basket = __webpack_require__(253);
	    ...
	    _createClass(Basket, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: "checkout " + isBasketEmptyClass },
	                    _react2.default.createElement(
	                        _reactRouter.Link,
	                        { to: "confirmed" },
	                        'Checkout'
	...
	exports.default = (0, _reactRedux.connect)(select)(Basket);
...
/***/ function(module, exports) {
	...
	function getCookieValue(name) {
	    var matchedValue = document.cookie.match(new RegExp(name + '=([^;]+)'));
	    if (matchedValue) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ConfirmationPage = function (_React$Component) {
	    ...
	    function ConfirmationPage() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ConfirmationPage).apply(this, arguments));
	    }
	        ...
	        value: function render() {
	            ...
	            if (this.props.selectedProducts.length > 0) {
	                products = this.props.selectedProducts.map(function (product, i) {
	                    return _react2.default.createElement(
	                        'label',
	                        { style: { 'display': 'block', 'marginTop': '1px' }, key: i },
	                        ' ',
	                        product,
	                        ' '
	                    );
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'label',
	                    { style: { 'textAlign': 'center', 'display': 'block', 'marginTop': '20px', 'height': '45px', 'fontSize': '28px' } },
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'label',
	                        { style: { 'display': 'block', 'fontSize': '20px', 'marginBottom': '10px' } },
	                        ' Selected products '
	                    ),
	                    products
	                )
	...
	exports.default = (0, _reactRedux.connect)(select)(ConfirmationPage);
	...
	var ErrorPage = function (_React$Component) {
	    ...
	    _createClass(ErrorPage, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { style: { 'textAlign': 'center', 'marginTop': 100 + 'px', 'fontSize': 26 + 'px' } },
...
/***/ function(module, exports, __webpack_require__) {
	...
	function productsReducer() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? { "products": {} } : arguments[0];
	...
	function basketReducer() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? { "basket": [] } : arguments[0];
	    var action = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];

	    switch (action.type) {
	        case types.PRODUCT_SELECTED:
	            return Object.assign({}, { "basket": [].concat(_toConsumableArray(state.basket), [action.text]) });
	        case types.PRODUCT_DESELECTED:
	            var productIndex = state.basket.indexOf(action.text);
	            return Object.assign({}, { "basket": [].concat(_toConsumableArray(state.basket.slice(0, productIndex)), _toConsumableArray(state.basket.slice(productIndex + 1))) });
	...
	var reducer = (0, _redux.combineReducers)(Object.assign({}, { allProducts: productsReducer }, { selectedProducts: basketReducer }));
